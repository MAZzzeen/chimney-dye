...
#ticks are different because they do not depend on a certain unit or a clock and instead depend on the internal clock of the computer and how fast the code is going